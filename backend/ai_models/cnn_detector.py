...
# ==================== FIX FOR PYTORCH 2.6+ ====================
# This allows YOLO models to load with weights_only=True default
try:
    from ultralytics.nn.tasks import DetectionModel
    torch.serialization.add_safe_globals([DetectionModel])
    print("[CNN] Added safe globals for YOLO model loading")
except ImportError:
    print("[CNN] Could not import DetectionModel, continuing anyway")
# ==============================================================
...
class CNNDetector:
    def __init__(self):
        ...
        # First run will download the model automatically (~20MB)
    ...
    def detect(self, image_path: str) -> tuple:
        ...
        try:
            ...
            results = self.model(image_path, conf=0.25, iou=0.45, verbose=False)
    ...
    def detect_multiple(self, image_path: str, min_confidence: float = 0.25) -> list:
        ...
        try:
            results = self.model(image_path, conf=min_confidence, iou=0.45, verbose=False)
            detections = results[0].boxes
